...
export const SiriOrb: React.FC<SiriOrbProps> = ({
    ...
    // Brand blue (#0066FF) converted to oklch and variations
    const defaultColors = {
        bg: "transparent",
        c1: "oklch(55% 0.22 255)",      // Primary brand blue
        c2: "oklch(65% 0.18 250)",      // Lighter blue
        c3: "oklch(50% 0.20 260)",      // Deeper blue accent
    }
